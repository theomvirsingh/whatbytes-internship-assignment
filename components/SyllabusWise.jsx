...
const SyllabusWise = () => {
  return (
    <div className='w-full p-4 sm:p-6 md:p-8 border border-gray-200 rounded-lg mt-5'>
      <h2 className='font-semibold text-base sm:text-lg text-gray-900 mb-4 sm:mb-6 md:mb-9'>Syllabus Wise Analysis</h2>
      {topics.map((item, index) => (
        <div key={index} className='mb-4 sm:mb-5'>
          ...
          <div className='flex items-center justify-between gap-2 sm:gap-4'>
            <div className={`w-[75%] sm:w-[80%] h-[8px] sm:h-[10px] rounded-full ${item.bgColor}`}>
              <div
